...
@Component({
  selector: 'app-reportebimestral',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './reportebimestral.component.html',
  styleUrl: './reportebimestral.component.scss'
})
export class ReporteBimestralComponent {
  ...
  printReport() {
    ...
    if (popupWindow && printContent) {
      ...
      <body onload="window.print();window.close()">
        <div class="title">Reporte del Contribuyente - Bimestral</div>
