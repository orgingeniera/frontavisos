...
@Component({
  selector: 'app-excel-declaracionmensual',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './excel-declaracionmensual.component.html',
  styleUrl: './excel-declaracionmensual.component.scss'
})
export class ExcelDeclaracionMensualComponent {
  ...
  onUpload(): void {
    if (this.selectedFile) {
      this.isLoading = true; 
        this.excelUploadService.uploadExcelDeclaracionMensual(this.selectedFile).subscribe(
          (response: any) => {
